...
<body class="fondo">
    ...
    <!--CARRUSEL-->
    <h1 class="container titulos col-md-6">Productos </h1>
    <section>
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <a href="#">
                            <img src="/img/parce1.webp" class="d-block w-100" alt="...">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                        <a href="#">
                            <img src="/img/parce2.webp" class="d-block w-100" alt="...">
                            <div class="carousel-caption productos d-md-block">
                                <h5>Solo terreno</h5>
                                <p>lore lore ipsum</p>
                            </div>
                    ...
                    <div class="carousel-item">
                        <a href="#">
                            <img src="/img/parce3.webp" class="d-block w-100" alt="...">
                            <div class="carousel-caption productos d-md-block">
                                <h5>Casa en parcela</h5>
                                <p>lore ipsum</p>
                            </div>
                        </a>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <footer class="titulos">
                    ...
                    <a href="https://www.instagram.com/terrasol_parcelas?igsh=eG51a2w4NGx5ODJu" target="_blank">
                        <img class="sociales" src="/img/1200px-Instagram_icon.png" alt="Instagram Icon"></a>
                    <a href="https://www.facebook.com/tuparcelaenelsurdechile?mibextid=ZbWKwL" target="_blank">
                        <img class="sociales" src="/img/2048px-Facebook_icon.png" alt="facebook Icon">
                    </a>
                </footer>
                <br>
